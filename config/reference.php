 ...
 *     google_maps_api_key?: scalar|Param|null, // Google Maps Platform API key (Map Tiles API). Null = maps and thumbnails fall back to the keyless satellite tiles. // Default: null
