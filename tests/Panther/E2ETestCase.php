 ...
 * database (uhifadhi_test_panther, via the TEST_TOKEN dbname suffix) which is dropped
...
abstract class E2ETestCase extends PantherTestCase
{
    ...
    private static function ensurePantherDatabase(): void
    {
        ...
        if (false === (false !== $statement ? $statement->fetchColumn() : false)) {
