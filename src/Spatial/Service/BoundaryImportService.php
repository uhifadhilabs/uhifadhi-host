...
final class BoundaryImportService
{
    ...
    private function convertWithOgr(string $path, string $extension): string
    {
        ...
        try {
            ...
            throw new BoundaryImportException(
                'The file could not be read as a GIS dataset — no polygon boundary found (supported: GeoJSON, zipped Shapefile, GeoPackage, KML/KMZ, zipped File Geodatabase — nested archives like WDPA downloads are scanned).',
            );
        } finally {
